...
/***/ function(module, exports, __webpack_require__) {
	...
	var GlobalMask = function (_React$Component) {
	  _inherits(GlobalMask, _React$Component);

	  function GlobalMask(props) {
	    _classCallCheck(this, GlobalMask);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GlobalMask).call(this, props));
	  }

	  _createClass(GlobalMask, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(_reactLoadingmask.LoadingMask, { state: true }),
	        React.createElement(
	          'div',
	...
	ReactDOM.render(React.createElement(GlobalMask, null), document.getElementById('GlobalMask'));
